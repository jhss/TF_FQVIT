...
from tfimm.architectures.resnetv2 import ResNetV2, ResNetV2Config, ResNetV2Stem

# model_registry will add each entrypoint fn to this
__all__ = ["QViT", "ViTBlock", "QViTConfig"]


@dataclass
class QViTConfig(ModelConfig):
    nb_classes: int = 1000
    in_channels: int = 3
...
@keras_serializable
class QViT(tf.keras.Model):
    cfg_class = QViTConfig
...
@register_model
def qvit_tiny_patch16_224():
    """ViT-Tiny (Vit-Ti/16)"""
    cfg = QViTConfig(
        name="qvit_tiny_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=192,
        nb_blocks=12,
...
@register_model
def qvit_tiny_patch16_384():
    """ViT-Tiny (Vit-Ti/16) @ 384x384."""
    cfg = QViTConfig(
        name="qvit_tiny_patch16_384",
        url="[timm]",
        input_size=(384, 384),
        patch_size=16,
        embed_dim=192,
...
@register_model
def qvit_small_patch32_224():
    """ViT-Small (ViT-S/32)"""
    cfg = QViTConfig(
        name="qvit_small_patch32_224",
        url="[timm]",
        patch_size=32,
        embed_dim=384,
        nb_blocks=12,
...
@register_model
def qvit_small_patch32_384():
    """ViT-Small (ViT-S/32) at 384x384."""
    cfg = QViTConfig(
        name="qvit_small_patch32_384",
        url="[timm]",
        input_size=(384, 384),
        patch_size=32,
        embed_dim=384,
...
@register_model
def qvit_small_patch16_224():
    """ViT-Small (ViT-S/16)"""
    cfg = QViTConfig(
        name="qvit_small_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=384,
        nb_blocks=12,
...
@register_model
def qvit_small_patch16_384():
    """ViT-Small (ViT-S/16)"""
    cfg = QViTConfig(
        name="qvit_small_patch16_384",
        url="[timm]",
        input_size=(384, 384),
        patch_size=16,
        embed_dim=384,
...
@register_model
def qvit_large_patch32_224():
    """
    ViT-Large model (ViT-L/32) from original paper (https://arxiv.org/abs/2010.11929).
    No pretrained weights.
    """
    cfg = QViTConfig(
        name="qvit_large_patch32_224",
        url="[timm]",
        patch_size=32,
        embed_dim=1024,
        nb_blocks=24,
...
@register_model
def qvit_base_patch16_sam_224():
    """
    ViT-Base (ViT-B/16) w/ SAM pretrained weights.
    Paper: https://arxiv.org/abs/2106.01548
    """
    cfg = QViTConfig(
        name="qvit_base_patch16_sam_224",
        url="[timm]",
        patch_size=16,
        embed_dim=768,
        nb_blocks=12,
...
@register_model
def qvit_tiny_patch16_224_in21k():
    """
    ...
    """
    cfg = QViTConfig(
        name="qvit_tiny_patch16_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=16,
        embed_dim=192,
...
@register_model
def qvit_small_patch32_224_in21k():
    """
    ...
    """
    cfg = QViTConfig(
        name="qvit_small_patch32_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=32,
        embed_dim=384,
...
@register_model
def qvit_small_patch16_224_in21k():
    """
    ViT-Small (ViT-S/16) ImageNet-21k weights @ 224x224, source
    https://github.com/google-research/vision_transformer.
    Note: This model has a valid 21k classifier head and no representation layer.
    """
    cfg = QViTConfig(
        name="qvit_small_patch16_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=16,
        embed_dim=384,
...
@register_model
def qvit_base_patch32_224_in21k():
    """
    ViT-Base model (ViT-B/32) from original paper (https://arxiv.org/abs/2010.11929).
    ...
    """
    cfg = QViTConfig(
        name="qvit_base_patch32_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=32,
        embed_dim=768,
...
@register_model
def qvit_base_patch16_224_in21k():
    """
    ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source
    https://github.com/google-research/vision_transformer.
    ...
    """
    cfg = QViTConfig(
        name="qvit_base_patch16_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=16,
        embed_dim=768,
...
@register_model
def qvit_base_patch8_224_in21k():
    ...
    """
    cfg = QViTConfig(
        name="qvit_base_patch8_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=8,
        embed_dim=768,
...
@register_model
def qvit_large_patch32_224_in21k():
    """
    ViT-Large model (ViT-L/32) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source
    https://github.com/google-research/vision_transformer.
    ...
    """
    cfg = QViTConfig(
        name="qvit_large_patch32_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=32,
        embed_dim=1024,
...
@register_model
def qvit_large_patch16_224_in21k():
    """
    ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source
    https://github.com/google-research/vision_transformer.
    ...
    """
    cfg = QViTConfig(
        name="qvit_large_patch16_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=16,
        embed_dim=1024,
...
@register_model
def qvit_huge_patch14_224_in21k():
    """
    ...
    """
    cfg = QViTConfig(
        name="qvit_huge_patch14_224_in21k",
        url="[timm]",
        nb_classes=21843,
        patch_size=14,
        embed_dim=1280,
...
@register_model
def qdeit_tiny_patch16_224():
    """
    DeiT-tiny model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_tiny_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=192,
        nb_blocks=12,
...
@register_model
def qdeit_small_patch16_224():
    """
    DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_small_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=384,
        nb_blocks=12,
...
@register_model
def qdeit_base_patch16_224():
    """
    DeiT base model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_base_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=768,
        nb_blocks=12,
...
@register_model
def qdeit_base_patch16_384():
    """
    DeiT base model @ 384x384 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_base_patch16_384",
        url="[timm]",
        input_size=(384, 384),
        patch_size=16,
        embed_dim=768,
...
@register_model
def qdeit_tiny_distilled_patch16_224():
    """
    DeiT-tiny distilled model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_tiny_distilled_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=192,
        nb_blocks=12,
...
@register_model
def qdeit_small_distilled_patch16_224():
    """
    DeiT-small distilled model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_small_distilled_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=384,
        nb_blocks=12,
...
@register_model
def qdeit_base_distilled_patch16_224():
    """
    DeiT-base distilled model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_base_distilled_patch16_224",
        url="[timm]",
        patch_size=16,
        embed_dim=768,
        nb_blocks=12,
...
@register_model
def qdeit_base_distilled_patch16_384():
    """
    DeiT-base distilled model @ 384x384 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    cfg = QViTConfig(
        name="qdeit_base_distilled_patch16_384",
        url="[timm]",
        input_size=(384, 384),
        patch_size=16,
        embed_dim=768,
...
@register_model
def qvit_base_patch16_224_miil_in21k():
    """ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    Weights taken from: https://github.com/Alibaba-MIIL/ImageNet21K
    See paper: https://arxiv.org/pdf/2104.10972v4.pdf
    """
    cfg = QViTConfig(
        name="qvit_base_patch16_224_miil_in21k",
        url="[timm]",
        nb_classes=11221,
        input_size=(224, 224),
        patch_size=16,
...
@register_model
def qvit_base_patch16_224_miil():
    """
    ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    Weights taken from: https://github.com/Alibaba-MIIL/ImageNet21K
    See paper: https://arxiv.org/pdf/2104.10972v4.pdf
    """
    cfg = QViTConfig(
        name="qvit_base_patch16_224_miil",
        url="[timm]",
        input_size=(224, 224),
        patch_size=16,
        embed_dim=768,
