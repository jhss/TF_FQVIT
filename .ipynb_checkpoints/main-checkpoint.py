...
def validation(model, valid_loader, args):
    ...
    for iter, data in enumerate(valid_loader.batch(args.batch_size).prefetch(1)):
        ...
        print(f"[{iter}/10]: Currrent Top1 {cur_top1.result().numpy():.5f} / Top5 {cur_top5.result().numpy():.5f}")
...
if __name__ == '__main__':
    ...
    # Preprocess
    print(f"[DEBUG] Start to create model: {args.model_name}")
    ...
    print("[DEBUG] Start Post Training Quantization")
